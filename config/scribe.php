...
return [
    ...
    'description' => 'ThreadForge API helps technology content creators transform raw technical content into optimized X (Twitter) posts using AI. Create reusable style configurations (Blueprints), submit raw content, generate structured social media posts, and manage the full content lifecycle.',

    'intro_text' => <<<'INTRO'
            Welcome to the ThreadForge API. This API enables you to:
            ...
            All endpoints returning user-specific data are scoped to the authenticated user. You can only access your own resources.
        INTRO,
    ...
    'auth' => [
        ...
        'extra_info' => 'You can retrieve your token by registering via **POST /api/register** or logging in via **POST /api/login**. The token is returned in the `token` field of the response.',
    ],
